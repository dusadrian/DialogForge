 ...
 * @returns {string}
 */
export function normalizeLiveScriptTicket(ticket_json) {
    let deferred3_0;
    let deferred3_1;
    try {
        const ptr0 = passStringToWasm0(ticket_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.normalizeLiveScriptTicket(ptr0, len0);
        var ptr2 = ret[0];
        var len2 = ret[1];
        if (ret[3]) {
            ptr2 = 0; len2 = 0;
...
function __wbg_adapter_33(arg0, arg1) {
    wasm._dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__hb3a7e7bdf55412ba(arg0, arg1);
}

function __wbg_adapter_36(arg0, arg1) {
    wasm._dyn_core__ops__function__Fn_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__hd7c25fa05e490b9a(arg0, arg1);
}

function __wbg_adapter_39(arg0, arg1) {
    wasm._dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__ha434db71dabd3b59(arg0, arg1);
}
...
function __wbg_adapter_45(arg0, arg1) {
    wasm._dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__hc1daa0bdda595118(arg0, arg1);
}
...
const LiveScriptClientFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_livescriptclient_free(ptr >>> 0, 1));
/**
...
export class LiveScriptClient {
    ...
    static __wrap(ptr) {
        ptr = ptr >>> 0;
        const obj = Object.create(LiveScriptClient.prototype);
        obj.__wbg_ptr = ptr;
        LiveScriptClientFinalization.register(obj, obj.__wbg_ptr, obj);
        return obj;
    }
    ...
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        LiveScriptClientFinalization.unregister(this);
        return ptr;
    }

    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_livescriptclient_free(ptr, 0);
    }
    /**
     * @param {string} frame_json
     * @returns {Promise<void>}
     */
    sendFrame(frame_json) {
        const ptr0 = passStringToWasm0(frame_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.livescriptclient_sendFrame(this.__wbg_ptr, ptr0, len0);
        return ret;
    }
    /**
     * @returns {string}
    ...
    get endpointId() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.livescriptclient_endpointId(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
     ...
     */
    receiveFrame() {
        const ret = wasm.livescriptclient_receiveFrame(this.__wbg_ptr);
        return ret;
    }
    /**
     * @returns {Promise<string>}
     */
    transportAddress() {
        const ret = wasm.livescriptclient_transportAddress(this.__wbg_ptr);
        return ret;
    }
    /**
     * @returns {string}
    ...
    get remoteEndpointId() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.livescriptclient_remoteEndpointId(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
    ...
    get state() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.livescriptclient_state(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
     ...
     */
    shutdown() {
        const ret = wasm.livescriptclient_shutdown(this.__wbg_ptr);
        return ret;
    }
}
...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbg_livescriptclient_new = function(arg0) {
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('dialogforge_iroh_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
