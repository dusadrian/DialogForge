...
} from "../features/plot-viewer/plotExternalIpc";
import {
    shellWindowEventChannels
} from "../features/main-window/shellWindowIpc";
import type {
...
export const applicationEventChannels = {
    ...
    browserFrameKeyDown: "base-app:browser-frame-keydown",
    updateDownloadProgress: "base-app:update-download-progress",
...
export interface ApplicationEventPayloads {
    ...
    "base-app:browser-frame-keydown": {
        key: string;
        code: string;
        ctrlKey: boolean;
        metaKey: boolean;
    ...
    "base-app:update-download-progress": {
        active: boolean;
        percent: number;
        productName?: string;
    };
