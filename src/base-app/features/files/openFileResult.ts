...
export const createOpenFileResult = function(
    input: Partial<OpenFileDialogResult>
): OpenFileResult {
...
export const createPathInfoResult = function(
    input: Partial<PathInfoResult>
): PathInfoResult {
    return {
...
export const createOpenDirectoryResult = function(
    input: Partial<OpenFileDialogResult>
): OpenFileResult {
    const filePaths = input.filePaths || [];
