...
import {
  ...
  getMinimumScrolledVariableRows,
...
const variableGridInteractions =
  createVariableGridInteractionBindings({
    ...
    openValueLabels: openHydratedValueLabelsEditor,
...
const datasetEditorInitialization = createDatasetEditorInitializationController({
  ...
  setLanguage: (locale, appPath, directTranslations) => {
    localization.setLanguage(locale, appPath, directTranslations);
  },
