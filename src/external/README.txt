Dialog external-call code in this directory is provider-neutral and shared across products.
...
If dialog external-call code is reusable by all products and all providers, this is the home
for it.
